            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑材料</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>材料种类</label>
                                       <select id="goodsTypesSelect" name="goodsTypes" class="form-control">
                                       </select>
                                   </div>
                                <div class="form-group col-md-6">
                                    <label>材料数量</label>
                                    <input id="goodsNumber" name="goodsNumber" class="form-control"
                                           onchange="goodsNumberChickValue(this)"  placeholder="材料数量">
                                </div>
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="danjia" name="danjia" class="form-control"
                                            onchange="danjiaChickValue(this)" placeholder="单价">
                                 </div>
                                   <div class="form-group  col-md-6">
                                       <label>材料详情</label>
...
<script>
    ...
    function getContent() {
        ...
        if (goodsContentEditor.hasContents()) {
                $('#goodsContent-input').attr('value', goodsContentEditor.getPlainTxt());
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
        function goodsNumberChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                goodsName: "材料名字不能为空",
                goodsTypes: "材料种类不能为空",
                goodsNumber: "材料数量不能为空",
                goodsPhoto: "材料图片不能为空",
                danwei: "单位不能为空",
                danjia: "单价不能为空",
                goodsContent: "材料详情不能为空",
                flag: "是否删除不能为空",
            }
        }).form();
    }
