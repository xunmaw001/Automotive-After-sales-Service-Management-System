            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">出入库订单详情登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="orderName" name="orderName" class="form-control"
                                                   v-model="ruleForm.orderName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="orderValue" name="orderValue" class="form-control"
                                               v-model="ruleForm.orderValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="inOutOrderId" name="inOutOrderId" v-model="ruleForm.inOutOrderId" readonly type="hidden">
                                <input id="goodsId" name="goodsId" v-model="ruleForm.goodsId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="orderNumber" name="orderNumber" class="form-control"
                                               v-model="ruleForm.orderNumber" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "inOutOrderList/info/" + id,
