                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 aaaaaa in_out_order">
                                        <label>出入库订单</label>
                                        <div>
                                    ...
                                    <div class="form-group col-md-6 in_out_order">
                                        <label>订单名</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            let data = {};
            getContent();
            if(window.sessionStorage.getItem('role') != '出入库订单'){//当前登录用户不为这个
            ...
            if(window.sessionStorage.getItem('role') != '材料'){//当前登录用户不为这个
                if($("#goodsId") !=null){
